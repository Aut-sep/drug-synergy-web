...
parser.add_argument("--drug-epochs", type=int, default=None)
parser.add_argument("--cell-epochs", type=int, default=None)
...
drug_epochs = 3000
drug_patience = 100
if args.drug_epochs is not None:
    drug_epochs = args.drug_epochs
if args.patience is not None:
    drug_patience = args.patience
...
if args.cell_epochs is not None:
    cell_line_epochs = args.cell_epochs
if args.patience is not None:
    cell_line_patience = args.patience
